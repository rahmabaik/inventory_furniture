...
<body>
    ...
    <h1>Order List</h1>
    <a href="<?= base_url('orders/create') ?>" class="add-order"><i class="fas fa-plus"></i> Add New Order</a>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="<?= base_url('orders/edit/' . $order['ID']) ?>"><i class="fas fa-edit"></i> Edit</a>
                    <form action="<?= base_url('orders/delete/' . $order['ID']) ?>" method="post" style="display:inline;">
