...
<body>
    ...
    <h1>Category List</h1>
    <a href="<?= base_url('categories/create') ?>" class="add-category"><i class="fas fa-plus"></i> Add New Category</a>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="<?= base_url('categories/edit/' . $category['ID']) ?>"><i class="fas fa-edit"></i> Edit</a>
