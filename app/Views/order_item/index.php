...
<body>
    ...
    <a href="<?= base_url('order_item/create') ?>" class="add-order-item"><i class="fas fa-plus"></i> Add New Order Item</a>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $orderItem['furniture_name'] ?></td>
                <td><?= $orderItem['quantity'] ?></td>
                <td><?= number_format($orderItem['price'], 2) ?></td>
                <td>
                    <a href="<?= base_url('order_item/edit/' . $orderItem['ID']) ?>"><i class="fas fa-edit"></i> Edit</a>
                    <form action="<?= base_url('order_item/delete/' . $orderItem['ID']) ?>" method="post" style="display:inline;">
