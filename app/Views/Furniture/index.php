...
<body>
    ...
    <a href="<?= base_url('furniture/create') ?>" class="add-furniture"><i class="fas fa-plus"></i> Add New Furniture</a>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="<?= base_url('furniture/edit/' . $item['ID']) ?>"><i class="fas fa-edit"></i> Edit</a>
                    <form action="<?= base_url('furniture/delete/' . $item['ID']) ?>" method="post" style="display:inline;">
